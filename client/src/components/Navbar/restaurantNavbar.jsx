...
<div className="flex items-center gap-3">
    <button className="bg-zomato-400 text-white py-2 px-3 rounded-full ">
        ...
        {reduxState?.user?.fullname?(
                 <>
                    <div onClick ={()=> setIsDropDown((prev)=> !prev)}
        ...
        src={gravatar.url(reduxState?.user?.email)}
         ...
         />
             ...
             {isDropDownOpen &&(
                 <div className="absolute shadow-lg py-3 w-full -bottom-20 -right-4 bg-white z-20 flex flex-col gap-2">
...
<div className="w-3/4 bg-white shadow-md p-3 flex items-center gap-3 border border-gray-200 rounded-full">
    <div className="flex items-center gap-2 border-r-2 border-gray-300 pr-2">
    <span className="text-zomato-400">
        <HiLocationMarker/>
    </span>
    <input type="text"  placeholder="Washim" className="focus outline-none"/>
    <IoMdArrowDropdown/>
    </div>
  ...
  <div className=" relative w-20">
        ...
        src={gravatar.url(reduxState?.user?.email)}
         ...
         />
              ...
              {isDropDownOpen &&    <div className="absolute shadow-lg py-3 w-full  -right-4 bg-white z-30 flex flex-col gap-2">
             <button>Sign Out</button>
         </div>}
                 </div> 
                 ):( 
