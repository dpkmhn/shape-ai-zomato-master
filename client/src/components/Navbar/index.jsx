...
<div className="w-3/4 bg-white shadow-md p-3 flex items-center gap-3 border border-gray-200 rounded-full">
    ...
    <input type="text"  placeholder="Bangaluru" className="focus outline-none"/>
    <IoMdArrowDropdown/>
    </div>
  ...
  <div className=" relative w-20">
        ...
        src={gravatar.url(reduxState?.user?.email)}
         ...
         />
              ...
              {isDropDownOpen &&  (
                <div className="absolute shadow-lg py-3 w-full  -right-4 bg-white z-30 flex flex-col gap-2">
             <button onClick={signOutHandler}>Sign Out</button>
         </div>
              )}
                 </div> 
